...
interface VersionControlApi {
    ...
    fun indexupdate1(@Query("platform") platform: kotlin.String, @Query("current_version") currentVersion: kotlin.Double, @Query("last_version") lastVersion: kotlin.Double, @Header("X-Application-Id") xminusApplicationMinusId: kotlin.String, @Header("X-Rest-Api-Key") xminusRestMinusApiMinusKey: kotlin.String): Call<Unit>
    ...
    fun markupdateasseen1(@Header("X-Application-Id") xminusApplicationMinusId: kotlin.String, @Header("X-Rest-Api-Key") xminusRestMinusApiMinusKey: kotlin.String, @Field("guid") guid: kotlin.Int, @Field("update_id") updateId: kotlin.Int, @Field("answer") answer: kotlin.String, @Field("type") type: kotlin.String): Call<Unit>
