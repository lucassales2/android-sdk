...
interface FilesApi {
    ...
    fun storewithpath(@Header("X-Application-Id") xminusApplicationMinusId: kotlin.String, @Header("X-Rest-Api-Key") xminusRestMinusApiMinusKey: kotlin.String, @Header("Content-Type") contentMinusType: kotlin.String, @Field("name") name: kotlin.String, @Field("tags") tags: kotlin.String, @Field("gone_at") goneAt: kotlin.String): Call<Unit>
