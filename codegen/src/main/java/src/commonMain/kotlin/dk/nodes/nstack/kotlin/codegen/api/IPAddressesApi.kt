...
class IPAddressesApi @UseExperimental(UnstableDefault::class) constructor(
    ...
    * @return void
    */
    suspend fun getShow112(ip: kotlin.String, xminusApplicationMinusId: kotlin.String, xminusRestMinusApiMinusKey: kotlin.String) : HttpResponse<Unit> {
    ...
    * @return void
    */
    suspend fun getShow12345(ip: kotlin.String, xminusApplicationMinusId: kotlin.String, xminusRestMinusApiMinusKey: kotlin.String) : HttpResponse<Unit> {
