...
class ResponsesApi @UseExperimental(UnstableDefault::class) constructor(
    ...
    * @return void
    */
    suspend fun show(xminusApplicationMinusId: kotlin.String, xminusRestMinusApiMinusKey: kotlin.String, contentMinusType: kotlin.String) : HttpResponse<Unit> {
    ...
    * @return void
    */
    suspend fun show1(xminusApplicationMinusId: kotlin.String, xminusRestMinusApiMinusKey: kotlin.String, contentMinusType: kotlin.String) : HttpResponse<Unit> {
